package com.hedvig.android.owldroid.ui.claims.quickactions
...
class QuickActionsAdapter(private val quickActions: List<ClaimsQuickAction>): RecyclerView.Adapter<QuickActionsAdapter.ViewHolder>(){
